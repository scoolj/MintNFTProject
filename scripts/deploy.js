async function main() {
  ...
  const MyToken = await hre.ethers.getContractFactory("Scoolj");
  ...
  await nft.safeMint(await signer0.getAddress(), "ipfs://QmcvFqU5iaayGCpjf9sx9oJkdbCGWiNW2mUq8UcEBT2E93");
